...
export function AppBottomNav() {
  ...
  return (
    <nav
      aria-label="Navegacao principal do app"
      className="pointer-events-none fixed inset-x-0 bottom-0 z-40 px-4 pb-[calc(0.9rem+var(--app-safe-bottom))]"
    >
      {timerOpen ? (
        <div className="pointer-events-auto mx-auto mb-3 w-full max-w-[var(--app-shell-max)] rounded-[28px] border border-white/10 bg-[#070907]/92 p-2 shadow-[0_24px_70px_rgba(0,0,0,0.52)] backdrop-blur-2xl">
          <RestTimer title="Cronômetro" suggestedSeconds={suggestedSeconds} initialSeconds={suggestedSeconds} compact />
        </div>
      ) : null}

      <div className="mx-auto w-full max-w-[var(--app-shell-max)] rounded-[28px] border border-white/10 bg-[#070907]/88 p-2 shadow-[0_24px_70px_rgba(0,0,0,0.48)] backdrop-blur-2xl">
